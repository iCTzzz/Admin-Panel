...
const formSchema = z.object({
  ...
  estimatedRevenue: z.coerce.number().min(0, "Revenue is required"),
});
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Track and manage ongoing work.</p>
          </div>
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-4">
                    ...
                    <FormField control={form.control} name="estimatedRevenue" render={({ field }) => (
                      <FormItem><FormLabel>Estimated Revenue ($)</FormLabel><FormControl><Input type="number" placeholder="5000" {...field} /></FormControl><FormMessage /></FormItem>
                    )} />
                ...
                <CardContent className="py-4 flex-1">
                  <div className="grid grid-cols-2 gap-y-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium flex items-center"><CalendarDays className="h-3 w-3 mr-1.5 text-primary" /> {format(new Date(project.startDate), 'MMM d, yyyy')}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground text-xs uppercase tracking-wider mb-1">Value</p>
